...
(function() {
  ...
  AbstractModel = (function(_super) {
    ...
    function AbstractModel() {
      this.twd = __bind(this.twd, this);
      return AbstractModel.__super__.constructor.apply(this, arguments);
    }

    AbstractModel.prototype.twd = function() {
      return view.twd;
    };
  ...
  AbstractCollection = (function(_super) {
    ...
    AbstractCollection.prototype.twd = function() {
      return view.twd;
    };
  ...
  AbstractData = (function() {
    ...
    AbstractData.prototype.twd = function() {
      return view.twd;
    };
  ...
  UserData = (function(_super) {
    ...
    UserData.prototype.onLogoutDone = function() {
      window.location.href = this.twd().BASE_PATH;
      return null;
    };
  ...
  AuthManager = (function(_super) {
    ...
    function AuthManager() {
      ...
      this.login = __bind(this.login, this);
      this.userData = this.twd().appData.USER;
  ...
  Share = (function() {
    ...
    Share.prototype.twitter = function(url, copy) {
      ...
      url = encodeURIComponent(url || this.url);
      if (copy === '') {
        copy = this.twd().locale.get('seo_twitter_card_description');
      }
  ...
  AbstractView = (function(_super) {
    ...
    AbstractView.prototype.initialize = function() {
      ...
      this.children = [];
      if (this.template) {
        tmpHTML = _.template(this.twd().templates.get(this.template));
    ...
    AbstractView.prototype.twd = function() {
      return view.twd;
    };
  ...
  AbstractViewPage = (function(_super) {
    ...
    AbstractViewPage.prototype.show = function(cb) {
       ...
       */
      this.twd().appView.wrapper.addChild(this);
      this.callChildrenAndSelf('setListeners', 'on');
    ...
    AbstractViewPage.prototype.hide = function(cb) {
      ...
      /*
      		CHANGE HERE - 'page' views are always in DOM - to save having to re-initialise gmap events (PITA). No longer require :dispose method
       */
      this.twd().appView.wrapper.remove(this);
  ...
  Footer = (function(_super) {
    ...
    function Footer() {
      this.templateVars = {
        desc: this.twd().locale.get("footer_desc")
      };
  ...
  Header = (function(_super) {
    ...
    function Header() {
      this.templateVars = {
        desc: this.twd().locale.get("header_desc"),
        home: {
          label: 'Go to homepage',
          url: this.twd().BASE_PATH + '/' + this.twd().nav.sections.HOME
        },
        example: {
          label: 'Go to example page',
          url: this.twd().BASE_PATH + '/' + this.twd().nav.sections.EXAMPLE
        }
      };
  ...
  Wrapper = (function(_super) {
    ...
    function Wrapper() {
      ...
      this.views = {
        home: {
          classRef: HomeView,
          route: this.twd().nav.sections.HOME,
          view: null,
          type: this.VIEW_TYPE_PAGE
        },
        quests: {
          classRef: ExamplePageView,
          route: this.twd().nav.sections.EXAMPLE,
          view: null,
          type: this.VIEW_TYPE_PAGE
        }
      };
    ...
    Wrapper.prototype.init = function() {
      this.twd().appView.on('start', this.start);
      return null;
    };

    Wrapper.prototype.start = function() {
      this.twd().appView.off('start', this.start);
      this.bindEvents();
      return null;
    };

    Wrapper.prototype.bindEvents = function() {
      this.twd().nav.on(Nav.EVENT_CHANGE_VIEW, this.changeView);
      this.twd().nav.on(Nav.EVENT_CHANGE_SUB_VIEW, this.changeSubView);
      return null;
    };
  ...
  ExamplePageView = (function(_super) {
    ...
    function ExamplePageView() {
      this.templateVars = {
        desc: this.twd().locale.get("example_desc")
      };
  ...
  HomeView = (function(_super) {
    ...
    function HomeView() {
      this.templateVars = {
        desc: this.twd().locale.get("home_desc")
      };
  ...
  AbstractModal = (function(_super) {
    ...
    function AbstractModal() {
      ...
      this.twd().appView.addChild(this);
    ...
    AbstractModal.prototype.hide = function() {
      this.animateOut((function(_this) {
        return function() {
          return _this.twd().appView.remove(_this);
        };
      })(this));
      return null;
    };
    ...
    AbstractModal.prototype.dispose = function() {
      ...
      this.twd().appView.modalManager.modals[this.name].view = null;
      return null;
    };
  ...
  OrientationModal = (function(_super) {
    ...
    OrientationModal.prototype.hide = function(stillLandscape) {
      ...
      this.animateOut((function(_this) {
        return function() {
          _this.twd().appView.remove(_this);
          if (!stillLandscape) {
    ...
    OrientationModal.prototype.setListeners = function(setting) {
      ...
      this.twd().appView[setting]('updateDims', this.onUpdateDims);
  ...
  Nav = (function(_super) {
    ...
    function Nav() {
      ...
      this.twd().router.on(Router.EVENT_HASH_CHANGED, this.changeView);
      return false;
    }
    ...
    Nav.prototype.changeView = function(area, sub, params) {
      ...
      if (this.twd().appView.modalManager.isOpen()) {
        this.twd().appView.modalManager.hideOpenModal();
      }
  ...
  Router = (function(_super) {
    ...
    Router.prototype.hashChanged = function(area, sub) {
      ...
      if (!this.area) {
        this.area = this.twd().nav.sections.HOME;
      }
  ...
  AppView = (function(_super) {
    ...
    AppView.prototype.navigateToUrl = function(href, e) {
      ...
      route = href.match(this.twd().BASE_PATH) ? href.split(this.twd().BASE_PATH)[1] : href;
      section = route.indexOf('/') === 0 ? route.split('/')[1] : route;
      if (this.twd().nav.getSection(section)) {
        if (e != null) {
          e.preventDefault();
        }
        this.twd().router.navigateTo(route);
      } else {
